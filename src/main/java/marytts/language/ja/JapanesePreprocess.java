...
import marytts.language.ja.preprocess.ExpansionPattern;
...
/**
 * A preprocessing module copied verbatim from the existing
 * italian and german. Japanese specific logic is in the patterns
 * themselves in preprocess/*EP.java
 *
 * Adapted from Marc Schr&ouml;der
 */

public class JapanesePreprocess extends InternalModule
{

	public JapanesePreprocess()
	{
		super("JapanesePreprocess",
	...
	public MaryData process(MaryData d)
		...
		logger.info("Expanding say-as elements...(ja)");
		expandSayasElements(doc);
		logger.info("Matching and expanding patterns...(ja)");
		matchAndExpandPatterns(doc);
		logger.info("Preprocess done (ja)");
