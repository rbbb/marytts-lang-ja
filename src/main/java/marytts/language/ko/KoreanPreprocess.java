...
import marytts.language.ko.preprocess.ExpansionPattern;
 ...
 * italian and german. Korean specific logic is in the patterns
 * themselves in preprocess/*EP.java
 *
 * @author Marc Schr&ouml;der
 */

public class KoreanPreprocess extends InternalModule
{

	public KoreanPreprocess()
	{
		super("KoreanPreprocess",
				MaryDataType.TOKENS,
				MaryDataType.WORDS,
				new Locale("ko"));
	}
	...
	public MaryData process(MaryData d)
		...
		logger.info("Expanding say-as elements...(ko)");
		expandSayasElements(doc);
		logger.info("Matching and expanding patterns...(ko)");
		matchAndExpandPatterns(doc);
		logger.info("Preprocess done (ko)");
